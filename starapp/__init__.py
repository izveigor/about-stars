...
def create_app(config="PRODUCTION"):
    app = Flask(__name__)
    app.config['SQLALCHEMY_DATABASE_URI'] = f'postgresql://{POSTGRESQL_SETTINGS["POSTGRES_USER"]}:{POSTGRESQL_SETTINGS["POSTGRES_PASSWORD"]}@db:5432/{POSTGRESQL_SETTINGS["POSTGRES_DB"]}'
