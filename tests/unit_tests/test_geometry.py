from starapp.geometry import is_points_range_valid, is_polygon_contains_point, Graham_scan
...
class TestGeometry:
    def test_is_polygon_contains_point(self, client):
        ...
        for ra, dec, result in zip(data_about_stars['ra'], data_about_stars['dec'], testing_data['result']):
